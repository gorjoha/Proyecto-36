...
function setup() {
  ...
  feed=createButton("Alimenta al perro");//no se si sea feed la variable correcta
...
function draw() {
  ...
  fill("white");
  textSize(20);
  text("Última hora en que se alimentó : 9 PM",240,30);
...
function feedDog(){
  ...
  if(lastFed>=12){
    //la hora en formato PM cuando lastFed sea mayor que 12
  }else if(lastFed==0){
